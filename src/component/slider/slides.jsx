...
const Slides = () => {
const slider =[
  {title: 'Welcome to ',id:"1" ,titleText: 'XStation' ,img :<img src={img1} alt='' style={{width:"100%" , height:"700px",opacity:"30%",background:"blue"}}/> , images:"../../images/male-electrician-works-switchboard-with-electrical-connecting-cable.jpg" , paragraph :'Finally you arrived to your destination with us', paragraph1 :' Start a new way with us toward your goal to', paragraph2 :'discover new ways to work and to enter ', paragraph3 :'new era of online jobs.  '},
